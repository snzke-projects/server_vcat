 ...
 * @project rest_demo
 */
package com.ucpaas.rest.client;
...
import com.ucpaas.rest.EncryptUtil;
import com.ucpaas.rest.SSLHttpClient;
import com.vcat.common.sms.UcpSmsRestClient;

public abstract class AbsRestClient {
	public boolean isTest=UcpSmsRestClient.isTest;
	public String server=UcpSmsRestClient.server;
	public String sslIP=UcpSmsRestClient.sslIP;
	public int sslPort=UcpSmsRestClient.sslPort;
	public String version=UcpSmsRestClient.version;
