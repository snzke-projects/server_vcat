...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String getDeadTime(Date reserveEndTime) {
		Date now = new Date();
		long l = reserveEndTime.getTime() - now.getTime();
     ...
     * @return
     */
    public static String getIntervalLabel(int interval){
        String yearShow = "";
        int year = 525600;
        int temp = interval;
        if(temp >= year){  // 年
	...
	public static void main(String[] args){
		...
		System.out.println(getDeadTime(endTime));
	}
}
