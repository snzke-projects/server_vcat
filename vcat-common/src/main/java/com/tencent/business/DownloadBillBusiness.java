...
public class DownloadBillBusiness {
    ...
    public DownloadBillBusiness(Configure configure) throws IllegalAccessException, ClassNotFoundException, InstantiationException, UnrecoverableKeyException, IOException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
    ...
    public void run(DownloadBillReqData downloadBillReqData,ResultListener resultListener,Configure configure
    ) throws Exception {
