...
public class ScanPayBusiness {
    ...
    public ScanPayBusiness(Configure configure) throws IllegalAccessException, ClassNotFoundException, InstantiationException, UnrecoverableKeyException, IOException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
    ...
    public void run(ScanPayReqData scanPayReqData, ResultListener resultListener) throws Exception {
        ...
        ReportReqData reportReqData = new ReportReqData(
                ...
                scanPayReqData.getSpbill_create_ip(),configure
        );
        ...
        if (scanPayResData.getReturn_code().equals("FAIL")) {
            ...
            //--------------------------------------------------------------------
            if (!Signature.checkIsSignValidFromResponseString(payServiceResponseString,configure)) {
    ...
    private boolean doOnePayQuery(String outTradeNo) throws Exception {
        ...
        ScanPayQueryReqData scanPayQueryReqData = new ScanPayQueryReqData("",outTradeNo,configure);
    ...
    private boolean doOneReverse(String outTradeNo) throws Exception {
        ...
        ReverseReqData reverseReqData = new ReverseReqData("",outTradeNo,configure);
