...
public class BaseService{
    ...
    public BaseService(String api,Configure configure) throws ClassNotFoundException, IllegalAccessException, InstantiationException, UnrecoverableKeyException, IOException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        apiURL = api;
