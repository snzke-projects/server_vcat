...
public class Product extends DataEntity<Product> {
    ...
    private Boolean isVirtualProduct;   // 是否为非实物商品（不需要发货）
    private Boolean canRefund;          // 是否支持退款
    ...
    public void setIsVirtualProduct(Boolean virtualProduct) {
        isVirtualProduct = virtualProduct;
    }
