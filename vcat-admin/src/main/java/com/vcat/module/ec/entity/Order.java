...
public class Order extends DataEntity<Order> {
    ...
    // 活动邮费订单
    public static final int ORDER_TYPE_POSTAGE = 5;
    // 预购进货订单
    public static final int ORDER_TYPE_RESERVE = 6;
    // V猫庄园订单
    public final static int ORDER_TYPE_VCATLEROY = 7;
    // 卖家开团订单
    public final static int ORDER_TYPE_GROUPBUY_SELLER = 8;
    // 买家开团/参团订单
    public final static int ORDER_TYPE_ROUPBUY_BUYER = 9;
    ...
    private boolean isFund = false;     // 该订单是否已处理佣金或分红
    private boolean isTeamBonus = false;// 该订单是否已处理团队分红

    private String [] productIdArray;   // 商品ID数组 订单查询时使用
    ...
    @ExcelField(title="订单备注", align=2, sort=120)
    ...
    @ExcelField(title="配送方", align=2, sort=45)
    ...
    public boolean getIsTeamBonus() {
        return isTeamBonus;
    }

    public void setIsTeamBonus(boolean teamBonus) {
        isTeamBonus = teamBonus;
    }
}
