...
public class ArchivedShopProductJob extends QuartzJobBean {
	...
	private final static String JOB_NAME_PRIFIX = "ADMIN_ARCHIVED_SP_";		// 任务名称前缀
    ...
    public static void deleteArchivedShopProductJob(String id){
        QuartzUtils.deleteJob(JOB_NAME_PRIFIX + id);
    }
}
