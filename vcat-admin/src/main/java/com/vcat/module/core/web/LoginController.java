...
//		try {
//			byte[] bytes = com.vcat.common.utils.FileUtils.readFileToByteArray(
//					com.vcat.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
...
//		System.out.println("==========================b");
        setDefaultTheme(request, response);
		return "module/sys/sysIndex";
	}
     ...
     * @param response
     */
    private void setDefaultTheme(HttpServletRequest request, HttpServletResponse response){
        String theme = CookieUtils.getCookie(request, "theme");
        if(StringUtils.isEmpty(theme)){
            CookieUtils.setCookie(response, "theme", "default");    // 设置为默认主题
        }
    }
