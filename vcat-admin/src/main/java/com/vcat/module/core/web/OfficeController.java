...
import com.vcat.module.core.service.OfficeService;
...
public class OfficeController extends BaseController {
	...
	public String form(Office office, Model model) {
		...
		office.setDistributionList(distributionService.findListByOfficeId(office.getId()));
	...
	public String save(Office office, Model model,HttpServletRequest request,
