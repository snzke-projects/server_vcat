...
import com.vcat.common.security.Digests;
...
import com.vcat.module.core.dao.MenuDao;
import com.vcat.module.core.dao.OfficeDao;
import com.vcat.module.core.dao.RoleDao;
import com.vcat.module.core.dao.UserDao;
...
import com.vcat.module.core.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public void updatePasswordById(String id, String loginName,
		...
		user.setPassword(EntryptUtils.entryptPassword(newPassword));
	...
	public Role getRole(String id) {
        ...
        if (role.getOffice()==null && StringUtils.isNotEmpty(role.getSqlMap().get("officeId"))){
            role.setOffice(officeDao.get(role.getSqlMap().get("officeId")));
        }
		return role;
	}
