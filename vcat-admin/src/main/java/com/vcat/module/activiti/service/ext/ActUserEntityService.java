package com.vcat.module.activiti.service.ext;
...
import com.vcat.module.activiti.utils.ActUtils;
import com.vcat.module.core.entity.Role;
import com.vcat.module.core.service.SystemService;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.vcat.module.core.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.vcat.module.core.entity.User(null, userId)))){
