...
import com.vcat.module.content.service.*;
import com.vcat.module.content.utils.CmsUtils;
import com.vcat.module.content.utils.TplUtils;
...
//        model.addAttribute("contentViewList",getTplContent());
        model.addAttribute("contentViewList", Arrays.asList("frontViewArticle"));
	...
	/**
	 * 文章选择列表
	 * @param lockCategory 是否锁定栏目
	 */
	@RequiresPermissions("cms:article:view")
	@RequestMapping(value = "selectList")
	public String selectList(Article article,boolean lockCategory,
                             @RequestParam(value = "selectType",required = false)String selectType,
                             @RequestParam(value = "callBackFuncName",required = false)String callBackFuncName,
                             HttpServletRequest request, HttpServletResponse response, Model model) {
        list(article, request, response, model);
		model.addAttribute("lockCategory", lockCategory);
		model.addAttribute("article", article);
        model.addAttribute("selectType", selectType);
        model.addAttribute("callBackFuncName", callBackFuncName);
