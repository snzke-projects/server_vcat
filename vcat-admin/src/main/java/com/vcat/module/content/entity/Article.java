package com.vcat.module.content.entity;
...
public class Article extends DataEntity<Article> {
	 ...
	 * @return url
	 */
	public String getUrlDynamic(Article article) {
	...
	public String getImagePath(){
		return QCloudUtils.createOriginalDownloadUrl(this.image);
	}
	 ...
	 * @return src
	 */
	public String formatImageSrcToWeb(String src) {
		ServletContext context = SpringContextHolder
				.getBean(ServletContext.class);
