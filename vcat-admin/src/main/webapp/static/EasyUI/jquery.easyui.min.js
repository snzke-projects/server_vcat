...
t.fitted=true;
p.fcount=_1b+1;
$(p).addClass("easyui-panel-noscroll");
if(p.tagName=="BODY"){
$("html").addClass("easyui-panel-fit");
}
}
...
p.fcount=_1b-1;
if(p.fcount==0){
$(p).removeClass("easyui-panel-noscroll");
if(p.tagName=="BODY"){
$("html").removeClass("easyui-panel-fit");
}
}
}
return false;
...
var _210=_20f.panel;
var _211=_210.children(".easyui-panel-header");
var _212=_210.children(".easyui-panel-body");
var _213=_210.children(".easyui-panel-footer");
if(_20e){
...
function _219(_21a){
$(_21a).addClass("easyui-panel-body")._size("clear");
...
var _224=$(_21e).siblings(".easyui-panel-footer");
if(opts.border){
_223.removeClass("easyui-panel-header-noborder");
body.removeClass("easyui-panel-body-noborder");
_224.removeClass("easyui-panel-footer-noborder");
}else{
_223.addClass("easyui-panel-header-noborder");
body.addClass("easyui-panel-body-noborder");
_224.addClass("easyui-panel-footer-noborder");
}
...
_20b(_220.children(".easyui-panel-header"));
_220.children(".easyui-panel-body").addClass("easyui-panel-body-noheader");
}else{
if(opts.header){
$(opts.header).addClass("easyui-panel-header").prependTo(_220);
}else{
var _225=_220.children(".easyui-panel-header");
if(!_225.length){
_225=$("<div class=\"easyui-panel-header\"></div>").prependTo(_220);
}
if(!$.isArray(opts.tools)){
_225.find("div.panel-tool .panel-tool-a").appendTo(opts.tools);
}
_225.empty();
var _226=$("<div class=\"easyui-panel-title\"></div>").html(opts.title).appendTo(_225);
if(opts.iconCls){
_226.addClass("easyui-panel-with-icon");
$("<div class=\"easyui-panel-icon\"></div>").addClass(opts.iconCls).appendTo(_225);
}
var tool=$("<div class=\"easyui-panel-tool\"></div>").appendTo(_225);
...
$(this).addClass($(this).attr("iconCls")).addClass("easyui-panel-tool-a").appendTo(tool);
});
}
}
if(opts.collapsible){
_227(tool,"easyui-panel-tool-collapse",function(){
...
if(opts.minimizable){
_227(tool,"easyui-panel-tool-min",function(){
_24b(_21e);
});
}
if(opts.maximizable){
_227(tool,"easyui-panel-tool-max",function(){
...
if(opts.closable){
_227(tool,"easyui-panel-tool-close",function(){
_239(_21e);
});
}
}
_220.children("div.panel-body").removeClass("easyui-panel-body-noheader");
}
};
...
function _222(){
if(opts.footer){
$(opts.footer).addClass("easyui-panel-footer").appendTo(_220);
$(_21e).addClass("easyui-panel-body-nobottom");
}else{
_220.children(".easyui-panel-footer").remove();
$(_21e).removeClass("easyui-panel-body-nobottom");
}
};
};
...
$(_22a).html($("<div class=\"easyui-panel-loading\"></div>").html(opts.loadingMessage));
}
...
var tool=_236.children(".easyui-panel-header").find("a.panel-tool-restore");
if(tool.length){
opts.maximized=true;
}
...
var body=_244.children(".easyui-panel-body");
var tool=_244.children(".easyui-panel-header").find("a.panel-tool-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
tool.addClass("easyui-panel-tool-expand");
if(_243==true){
...
var body=_248.children(".easyui-panel-body");
var tool=_248.children(".easyui-panel-header").find("a.panel-tool-collapse");
...
tool.removeClass("easyui-panel-tool-expand");
if(_247==true){
...
var tool=_24a.children(".easyui-panel-header").find("a.panel-tool-max");
if(opts.maximized==true){
return;
}
tool.addClass("easyui-panel-tool-restore");
...
var tool=_250.children(".easyui-panel-header").find("a.panel-tool-max");
if(opts.maximized==false){
return;
}
_250.show();
tool.removeClass("easyui-panel-tool-restore");
...
var _254=null;
$(window).unbind(".easyui-panel").bind("resize.panel",function(){
if(_254){
clearTimeout(_254);
}
...
return jq.panel("panel").children(".easyui-panel-footer");
},body:function(jq){
...
return jq.each(function(){
_25f(this,"body");
_25f($(this).siblings(".easyui-panel-footer")[0],"footer");
...
var p=$(el).parents(".easyui-panel-"+type+":first");
...
var ff=t.children(".easyui-panel-footer,footer");
return $.extend({},$.parser.parseOptions(_266,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("easyui-panel-header"):undefined),footer:(ff.length?ff.removeClass("easyui-panel-footer"):undefined)});
};
...
var cc=[];
if(opts.iconCls){
cc.push("<div class=\"easyui-panel-icon "+opts.iconCls+"\"></div>");
}
cc.push("<div class=\"easyui-panel-title layout-expand-title");
