...
call compressor\compressor.bat common\form.js
call compressor\compressor.bat common\mustache.js
call compressor\compressor.bat common\vcat.css
call compressor\compressor.bat common\vcat.js
call compressor\compressor.bat common\wsize.js
