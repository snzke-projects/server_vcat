	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			function getNotifyNum(){
				$.post("${ctx}/oa/oaNotify/self/count?updateSession=0&t="+new Date().getTime(),function(data){
            ...
            notifyInterval = setInterval(getNotifyNum, ${oaNotifyRemindInterval}); //</c:if>
		});
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<%--<li id="themeSwitch" class="dropdown">--%>      <!-- 取消主题切换 -->
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://vcat.com" target="_blank">vcat</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
