...
public class Withdrawal extends DataEntity<Withdrawal> {
	...
	public String getWithdrawalStatusLabel(){
		if(WITHDRAWAL_STATUS_UNTREATED.equals(withdrawalStatus)){
			return "未处理";
		}else if(WITHDRAWAL_STATUS_SUCCESS.equals(withdrawalStatus)){
			return "提现完成";
		}else if(WITHDRAWAL_STATUS_FAILURE.equals(withdrawalStatus)){
			return "提现失败";
		}else{
			return "未知状态";
		}
