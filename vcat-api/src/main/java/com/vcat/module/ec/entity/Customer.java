...
public class Customer extends DataEntity<Customer> {
	...
	private final String succOrderStatus = Order.ORDER_STATUS_COMPLETED;
	private final String succRefundStatus = Refund.REFUND_STATUS_COMPLETED;
    ...
    private Boolean hasTeamMember;
    private String safePass;//安全密码
	...
	public String getSuccOrderStatus() {
		return succOrderStatus;
	}
