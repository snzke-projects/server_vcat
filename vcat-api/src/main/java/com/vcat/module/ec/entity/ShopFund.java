...
public class ShopFund extends DataEntity<ShopFund> {
	...
	//2016年3月10日 新加入伯乐奖励
	//private BigDecimal boleAvailableFund; //伯乐可提现资金
    //private BigDecimal boleUsedFound; //伯乐已提现
    //private BigDecimal boleProcessingFund; //伯乐提现中
    private BigDecimal monthBoleTotalFund; //本月伯乐收入
    private BigDecimal boleTotalFund; //伯乐总收入
	//附加查询
    ...
    private BigDecimal monthInviteTotalFund;//本月邀请总收入
    private BigDecimal InviteTotalFund;//邀请总收入
    ...
    //public void setBoleAvailableFund(BigDecimal boleAvailableFund) {
    //    this.boleAvailableFund = boleAvailableFund;
    //}


    //public void setBoleProcessingFund(BigDecimal boleProcessingFund) {
    //    this.boleProcessingFund = boleProcessingFund;
    //}

    public BigDecimal getBoleTotalFund() {
        return boleTotalFund;
    }

    public void setBoleTotalFund(BigDecimal boleTotalFund) {
        this.boleTotalFund = boleTotalFund;
    }

    //public void setBoleUsedFound(BigDecimal boleUsedFound) {
    //    this.boleUsedFound = boleUsedFound;
    //}

    public BigDecimal getMonthBoleTotalFund() {
        return monthBoleTotalFund;
    }

    public void setMonthBoleTotalFund(BigDecimal monthBoleTotalFund) {
        this.monthBoleTotalFund = monthBoleTotalFund;
    }

    public BigDecimal getInviteAvailableFund() {
        return inviteAvailableFund;
    }

    public void setInviteAvailableFund(BigDecimal inviteAvailableFund) {
        this.inviteAvailableFund = inviteAvailableFund;
    }

    public BigDecimal getInviteProcessingFund() {
        return inviteProcessingFund;
    }

    public void setInviteProcessingFund(BigDecimal inviteProcessingFund) {
        this.inviteProcessingFund = inviteProcessingFund;
    }

    public BigDecimal getInviteUsedFund() {
        return inviteUsedFund;
    }

    public void setInviteUsedFund(BigDecimal inviteUsedFund) {
        this.inviteUsedFund = inviteUsedFund;
    }
	...
	public BigDecimal getSaleHoldFund() {
		return saleHoldFund == null ? new BigDecimal(0) : saleHoldFund;
	}
	...
	public BigDecimal getTotalSale() {
		return totalSale == null ? new BigDecimal(0) : totalSale;
	}
	...
	public void countMonthTotalFund(){
        ...
        monthBonusTotalFund = monthBonusTotalFund == null ? new BigDecimal(0)
                : monthBonusTotalFund;
        monthBoleTotalFund = monthBoleTotalFund == null ? new BigDecimal(0) : monthBoleTotalFund;
        this.setMonthTotalFund(monthSaleTotalFund.add(monthShareTotalFund)
                .add(monthLoadTotalFund).add(monthBonusTotalFund).add(monthBoleTotalFund));
	}
    //计算总可用收入
	...
	public String toString() {
		return "ShopFund{" +
				"loadProcessingFund=" + loadProcessingFund +
				", loadAvailableFund=" + loadAvailableFund +
				", loadUsedFund=" + loadUsedFund +
				", saleHoldFund=" + saleHoldFund +
				", saleProcessingFund=" + saleProcessingFund +
				", saleAvailableFund=" + saleAvailableFund +
				", saleUsedFund=" + saleUsedFund +
				", shareProcessingFund=" + shareProcessingFund +
				", shareAvailableFund=" + shareAvailableFund +
				", shareUsedFund=" + shareUsedFund +
				", bonusHoldFund=" + bonusHoldFund +
				", bonusProcessingFund=" + bonusProcessingFund +
				", bonusAvailableFund=" + bonusAvailableFund +
				", bonusUsedFund=" + bonusUsedFund +
				", inviteProcessingFund=" + inviteProcessingFund +
				", inviteAvailableFund=" + inviteAvailableFund +
				", inviteUsedFund=" + inviteUsedFund +
				", couponAvailableFund=" + couponAvailableFund +
				", couponUsedFund=" + couponUsedFund +
				", couponTotalFund=" + couponTotalFund +
				", monthBoleTotalFund=" + monthBoleTotalFund +
				", boleTotalFund=" + boleTotalFund +
				", monthSaleTotalFund=" + monthSaleTotalFund +
				", monthBonusTotalFund=" + monthBonusTotalFund +
				", monthShareTotalFund=" + monthShareTotalFund +
				", monthLoadTotalFund=" + monthLoadTotalFund +
				", monthInviteTotalFund=" + monthInviteTotalFund +
				", InviteTotalFund=" + InviteTotalFund +
				", monthTotalFund=" + monthTotalFund +
				", monthTotalShareCount=" + monthTotalShareCount +
				", totalShopProductCount=" + totalShopProductCount +
				", totalLoadAward=" + totalLoadAward +
				", totalSale=" + totalSale +
				", totalFund=" + totalFund +
				", totalAvailableFund=" + totalAvailableFund +
				", totalUsedFund=" + totalUsedFund +
				", totalProcessingFund=" + totalProcessingFund +
				'}';
	}
}
