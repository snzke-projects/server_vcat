...
public class Role extends DataEntity<Role> {
	...
	public static final String SHIP_HANDLER = "SHIP_HANDLER";
...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	public static boolean contains(List<Role> list,String enname){
		if(null == list || list.isEmpty() || StringUtils.isEmpty(enname)){
			return false;
		}
		for(Role r : list){
			if(enname.equals(r.getEnname())){
				return true;
			}
		}
		return false;
