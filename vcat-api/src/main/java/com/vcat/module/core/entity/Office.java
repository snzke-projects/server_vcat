...
import com.vcat.module.core.utils.TreeEntity;
...
//	private Integer sort;		// 排序
	...
	private String distributionIds;			    //该机构可管理供应商ID集合
	private List<Distribution> distributionList;//该机构可管理供应商集合
...
//		this.sort = 30;
	...
	public String getDistributionIds() {
		if(StringUtils.isNotEmpty(distributionIds)){
    ...
    public void setSupplierIds(String supplierIds) {
		this.distributionIds = supplierIds;
	}
